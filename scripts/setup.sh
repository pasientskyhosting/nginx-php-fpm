...
if [ ! -z "$NEW_RELIC_LICENSE_KEY" ]; then
    ...
    if [ -f /etc/php/7.1/fpm/conf.d/newrelic.ini ]; then
        rm -rf /etc/php/7.1/fpm/conf.d/newrelic.ini
    fi
    if [ -f /etc/php/7.1/cli/conf.d/newrelic.ini ]; then
        rm -rf /etc/php/7.1/cli/conf.d/newrelic.ini
    fi
